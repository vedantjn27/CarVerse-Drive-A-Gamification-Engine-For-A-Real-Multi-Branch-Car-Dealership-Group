import { Gauge, GitBranch, LayoutDashboard, LogOut, Medal, MonitorPlay, Moon, Route, ShieldCheck, Sun, Target, Trophy, UserRound } from 'lucide-react';
...
export function AppShell() {
  ...
  const visibleNav = session?.role === 'ADMIN' ? [...nav, { to:'/app/admin', label:'Admin controls', icon:ShieldCheck }] : [...nav, { to:'/app/hierarchy', label:'Hierarchy simulator', icon:GitBranch }];
